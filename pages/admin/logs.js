...
export default function AdminLogsPage({ menu }) {
  return (
    <DashboardLayout menu={menu}>
      <h1 className="text-2xl font-semibold mb-2">Logs</h1>
      <p className="opacity-80">View logs here. (Placeholder page)</p>
    </DashboardLayout>
  );
}
...
export async function getServerSideProps(context) {
  ...
  const ok = await permissionService.hasAccessToUrl(role, '/admin/logs');
